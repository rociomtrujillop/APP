...
object ScamRepository {
    ...
    fun getScams(): List<Scam> {
        return listOf(
            ...
            Scam(
                ...
                iconResId = R.drawable.ic_trabajo
            ),
            Scam(
                id = "sim_swapping",
                title = "SIM Swapping",
                summary = "Clonan tu número para robar códigos.",
                iconResId = R.drawable.ic_sim
            ),
            // Smishing (SMS)
            Scam(
                id = "alerta_banca_sms",
    ...
    fun getScamDetails(): Map<String, ScamDetail> {
        return mapOf(
            "ejecutivo_bancario" to ScamDetail(
                ...
                whatToDo = listOf(
                    ...
                    StepItem("No proporciones NINGÚN dato personal o bancario.", R.drawable.ic_silencio),
            ...
            "alerta_banca_sms" to ScamDetail(
                ...
                redFlags = listOf(
                    StepItem("Incluyen un enlace (URL) que lleva a un sitio web FALSO que imita al de tu banco.", R.drawable.ic_link),
